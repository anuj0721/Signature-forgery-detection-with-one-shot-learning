...
- Download and open [checking_forgery.ipynb](https://github.com/anuj0721/Signature-forgery-detection-with-one-shot-learning/blob/master/checking_forgery.ipynb) using Google Colab.
